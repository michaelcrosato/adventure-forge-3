...
test("the final-turn model copy marks the sheltered upgrade too late", async () => {
  ...
  assert.match(view.text, /sheltered finish is too late; light now/i);
  assert.match(input.text, /sheltered finish is too late; light now/i);
